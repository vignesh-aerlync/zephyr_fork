...
/* WKT timeout values (in ticks/counts) */
#define LCP84X_WKT_DEEP_SLEEP_TICKS 200
#define LCP84X_WKT_POWER_DOWN_TICKS 1000
#define LCP84X_WKT_SOFT_OFF_TICKS   100000
...
static void lpc84x_wkt_arm(uint32_t ticks_10khz)
{
	wkt_config_t config;
...
void pm_state_set(enum pm_state state, uint8_t id)
{
	...
	case PM_STATE_STANDBY:
		 ...
		 */
		lpc84x_wkt_arm(LCP84X_WKT_DEEP_SLEEP_TICKS);
		switch_to_fro();
	...
	case PM_STATE_SUSPEND_TO_IDLE:
		 ...
		 */
		lpc84x_wkt_arm(LCP84X_WKT_POWER_DOWN_TICKS);
		switch_to_fro();
	...
	case PM_STATE_SOFT_OFF:
		...
		lpc84x_wkt_arm(LCP84X_WKT_SOFT_OFF_TICKS);
